...
async def async_get_gateway_config(
    hass: HomeAssistant,
    CONFIG_SCHEMA: dict,
...
async def async_find_gateway_config_by_base_id(
...
async def async_find_gateway_config_by_id(
    id: int,
    hass: HomeAssistant,
    CONFIG_SCHEMA: dict,
    get_integration_config=async_integration_yaml_config,
...
async def async_get_gateway_config_serial_port(
    hass: HomeAssistant,
    CONFIG_SCHEMA: dict,
    get_integration_config=async_integration_yaml_config,
) -> dict:
...
async def async_get_home_assistant_config(
    hass: HomeAssistant,
    CONFIG_SCHEMA: dict,
    get_integration_config=async_integration_yaml_config,
) -> dict:
...
async def async_get_list_of_gateway_descriptions(
    hass: HomeAssistant,
    CONFIG_SCHEMA: dict,
    get_integration_config=async_integration_yaml_config,
    filter_out: list[str] = [],
...
def get_gateway_name(
    dev_name: str, dev_type: str, dev_id: int, base_id: AddressExpression
) -> str:
...
def get_device_name(
    dev_name: str, dev_id: AddressExpression, general_config: dict
) -> str:
